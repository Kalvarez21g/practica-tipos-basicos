 ...
 */
    ...
    */
       public void ejercicio01() {
         ...
         System.out.println(cadena.append(año));
    ...
    */
       public void ejercicio03() {
         ...
         StringBuffer cadena=new StringBuffer("Viaje al Parnaso");
      // Modificaciones
         cadena.replace(cadena.indexOf("Parnaso"),cadena.length(),"Castalia");
    ...
    */
      ...
      cadena.insert(0,otraCadena);
      cadena.delete(otraCadena.lenght(),otraCadena.lenght()+5);
      System.out.println(cadena.toString());
      }
